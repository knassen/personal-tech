...
wrote over the years. They still work, as far as I can tell. Some
were for my job at ICPSR (Inter-university Consortium for Political
and Social Research at UM) when I worked there. We were always getting
new research study data submissions to add to the archives there. But
there were many checks and much documentation creation to get the study
data fully described. This included creating SAS and SPSS programs to
read the study data to make it useful for users. You'll see a few Perl
programs that were used for those tasks.
...
few lines, and a detail report of every match found. It always did this.
Now it does it with page numbers and titles on the summary as well as
the long, detailed listing. Page 1 had to be handled separately because
there is no line number information at that point and it's the start of
the detail listing.
...
**August 8, 2026** I'm having issues getting the pspp_matrix.html file
to index on Google.  It has been denied 4 times in the last 3 weeks.
