" Vim syntax file
" Language:	ICPSR add templates
" Maintainer:	Kent Nassen (knassen@umich.edu)
" Last change:	1997 September 11
...
" Keyword Definitions
"-------------------------------------------------------------------------
syntax keyword addStatement CDNET COBOL COVER FORTRAN FRONT Fortran HOTLINE MATTER MS-DOS OSIRIS PRIORITY RECODE RESTRICTIONS UPDATE
...
syntax match addDataFiles		/[0-9]* data fil[es]* +/me=e-2 contains=addSpecialCharacter4,addNumber
syntax match addWhy 			"why\?"
syntax match addAffiliation 	"affiliation is:"
syntax match addArchFilter1		" = ICPSR;"he=e-1,hs=s-2 contains=addArch,addSpecialCharacter3,addSpecialCharacter1
syntax match addArchFilter2		" = NACDA;"he=e-1,hs=s-2 contains=addArch,addSpecialCharacter3,addSpecialCharacter1
syntax match addArchFilter3		" = SAMHDA;"he=e-1,hs=s-2 contains=addArch,addSpecialCharacter3,addSpecialCharacter1
syntax match addArchFilter4		" = CJAIN;"he=e-1,hs=s-2 contains=addArch,addSpecialCharacter3,addSpecialCharacter1
syntax match addArchFilter5		" = EDUCATION;"he=e-1,hs=s-2 contains=addArch,addSpecialCharacter3,addSpecialCharacter1
...
syntax region addGoodSpace		start="^Is this a PRIO" end="^[ 	]*codebook parts will" skipempty 
...
syntax match addStartDate		"^[ ]*START\.DATE"
syntax match addEndDate			"^[ ]*END\.DATE"
syntax match addCountryIn		"^[ ]*COUNTRY\.IN\.SAMPLE"
syntax match addArchiveCode		"^[ ]*ARCHIVE\.CODE"

"-------------------------------------------------------------------------
" Syntax Patterns for Some Errors in an add/update Template
"-------------------------------------------------------------------------
...
syntax match addHyphenErr     	/[a-zA-Z]-$/ms=s+1 
syntax match addHyphenErr2    	/[0-9]*-$/

" Error: Spaces before a semicolon
syntax match addSemicolonErr 	/[ ]*;/me=e-1 contains=addUpdate,addSpecialCharacter1
...
highlight link addStartDate		Statement
highlight link addEndDate			Statement
highlight link addCountryIn		Statement
highlight link addArchiveCode		Statement
